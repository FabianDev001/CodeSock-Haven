...
export const metadata: Metadata = {
  title: 'CodeSock Haven',
  description: 'CodeSock Haven offers a stylish haven for programmers, providing a curated collection of comfortable and expressive socks designed for coding enthusiasts. Elevate your coding experience with our unique and high-quality programming socks, blending functionality with a touch of geek chic. Explore our range and step into the world of coding fashion at CodeSock Haven',
};
  ...
  return (
        ...
        <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              <Image
                src="/CodeSocks-Haven.png"
                width={50}
                height={50}
                alt="Coding Socks Haven Logo"
              />
            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <a href="/legal/press" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="https://discord.gg/kErh46Fer5" className="hover:underline">Discord</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">CodeSock Haven™</a>. All Rights Reserved.
          </span>
